...
`,S=(e=[],t=5)=>{const l=document.getElementById("carousel-element"),c=document.getElementById("carousel-interface-left"),s=document.getElementById("carousel-interface-right"),a=document.getElementsByClassName("carousel__progress-item");let r=parseInt(l.dataset.selected);c.addEventListener("click",o=>n("left")),s.addEventListener("click",o=>n("right"));for(let o of a)o.addEventListener("click",v=>{g(parseInt(v.target.dataset.progressId))});const n=(o,v=!1)=>{switch(o){case"left":r--;break;case"right":r++;break}r<0&&(r+=e.length),r>e.length-1&&(r-=e.length),v!==!0&&clearInterval(h),u()},g=(o,v=!1)=>{r=o,v!==!0&&clearInterval(h),u()},u=()=>{for(let o of a)o.setAttribute("data-active","false");a[r].setAttribute("data-active","true"),l.setAttribute("data-selected",r),l.style.setProperty("--selected-index",r)},h=setInterval(function(){n("right",!0)},t*1e3)},k=()=>{const e=document.querySelector("[data-open-modal]"),t=document.querySelector("[data-close-modal]"),l=document.querySelector("[data-modal]");e.addEventListener("click",()=>{l.showModal()}),t.addEventListener("click",()=>{l.close()})},z="/horse-staple/assets/a3-Cujp4sY9.webp",x="/horse-staple/assets/a4-DXvBsnzM.webp",B="/horse-staple/assets/b3-DQMiMc56.webp",W="/horse-staple/assets/c2-D7-WHc_v.webp",C="/horse-staple/assets/c3-BJazPEVg.webp",E="/horse-staple/assets/c4-DaQZ7szw.webp",M="/horse-staple/assets/d3-C16_8kbo.webp",U="/horse-staple/assets/e1-Bw6DOwaL.webp",K="/horse-staple/assets/e3-JsWtibTC.webp",T="/horse-staple/assets/f1-CRyZyF1r.webp",Q="PM1000 is a progress management tool for Paper Mario: The Thousand-Year Door. Keep track of multiple resources found in game to efficiently complete your collection of star pieces, shine sprites, badges, recipes and tattle logs!",f=[z,x,B,W,C,E,M,U,K,T];document.querySelector("#app").innerHTML=`
	${H()}
